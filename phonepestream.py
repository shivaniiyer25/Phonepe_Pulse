        ...
        # Transaction Analysis bar chart query
         ...
         # Transaction Analysis table query
            ...
            fig_tra = px.choropleth(
                ...
                color_continuous_scale='viridis', title='Transaction Analysis')
            ...
            df_in_tr_tab_qry_rslt1_piefig = px.pie(df_in_tr_tab_qry_rslt1, 
                                                values='Transaction_amount',  # Values for the pie chart
                                                names='State',  # Categories for the pie chart
                                                title='Transaction Analysis Pie Chart', 
                                                color='State',  # Optional: Color the pie chart segments by 'State'
                                                #color_continuos_scale ='viridis',  # Color palette for the pie chart segments
                                                height=450)
...
# ----   /   All India User Analysis Pie chart   /     -------- #
